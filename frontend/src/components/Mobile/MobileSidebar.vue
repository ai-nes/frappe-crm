...
const links = [
  ...
  { label: 'Học sinh THPT', icon: SchoolIcon, to: { name: 'CRM Students', query: { stage: 'intake' } } },
  { label: 'Hồ sơ sinh viên', icon: UsersIcon, to: 'CRM Contacts' },
  { label: 'Sinh viên đã nhập học', icon: GraduationCapIcon, to: { name: 'CRM Students', query: { stage: 'enrolled' } } },
  { label: 'Trường THPT', icon: SchoolIcon, to: 'High Schools' },
  { label: 'Các bên liên quan', icon: UserIcon, to: 'CRM Persons' },
  { label: 'Chiến dịch', icon: MegaphoneIcon, to: 'CRM Campaigns' },
  { label: 'Sự kiện', icon: CalendarIcon, to: 'CRM Events' },
  { label: 'Nhân viên', icon: BriefcaseIcon, to: 'CRM Staff' },
