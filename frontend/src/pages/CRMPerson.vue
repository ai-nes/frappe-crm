  ...
  <div v-if="doc.name" class="flex h-full overflow-hidden">
    ...
    <Resizer class="flex flex-col justify-between border-l" side="right">
      <div
        ...
        @click="copyToClipboard(crmPersonId)"
      >
        {{ __(doc.full_name || crmPersonId) }}
      </div>
      <div
        v-if="sections.data"
...
const { doctypeMeta } = getMeta('CRM Person')

const props = defineProps({
  crmPersonId: { type: String, required: true },
})
...
const { document, error } = useDocument('CRM Person', props.crmPersonId)
...
const title = computed(() => {
  ...
  return doc.value?.[t] || props.crmPersonId
})
