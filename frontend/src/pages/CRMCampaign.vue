  ...
  <div v-if="doc.name" class="flex h-full overflow-hidden">
    ...
    <Resizer class="flex flex-col justify-between border-l" side="right">
      <div
        ...
        @click="copyToClipboard(crmCampaignId)"
      >
        {{ __(doc.crm_campaign_name || crmCampaignId) }}
      </div>
      <div
        v-if="sections.data"
...
const props = defineProps({
  crmCampaignId: { type: String, required: true },
})
...
const title = computed(() => {
  ...
  return doc.value?.[t] || props.crmCampaignId
})
