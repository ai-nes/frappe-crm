  ...
  <div v-if="doc.name" class="flex h-full overflow-hidden">
    ...
    <Resizer class="flex flex-col justify-between border-l" side="right">
      <div
        ...
        @click="copyToClipboard(campaignId)"
      >
        {{ __(doc.campaign_name || campaignId) }}
      </div>
      <div
        v-if="sections.data"
...
const { document, error } = useDocument('Campaign', props.campaignId)
...
const breadcrumbs = computed(() => {
  ...
  items.push({
    label: doc.value?.campaign_name || props.campaignId,
