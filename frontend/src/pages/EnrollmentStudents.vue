...
import EnrollmentStudentsListView from '@/components/ListViews/EnrollmentStudentsListView.vue'
...
function createStudent() {
  showModal({
    doctype: 'Enrollment Student',
    title: __('New Enrollment Student'),
    callbacks: {
      afterInsert: (doc) => {
        router.push({ name: 'Enrollment Student', params: { enrollmentStudentId: doc.name } })
      },
    },
  })
}
