...
def authorize_attempt_for_send(attempt_id, *, channel=None):
	...
	if frappe.db.get_value("CRM Student", action.student, "privacy_status") == "opted_out" or (action.get("contact") and frappe.db.get_value("CRM Student", action.contact, "is_opted_out")):
		transition_attempt(attempt_id, "cancelled")
