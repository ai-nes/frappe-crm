...
def test_frappe_reference_shape_and_digest_are_stable():
	...
	decision_one = build_decision_ref("d-1", "student_nba", subject, "recommend", "nba-r1", evidence_refs=["score:score-1:7"], expires_at="2026-12-01T00:00:00Z")
...
def test_frappe_shared_refs_cover_decision_outcome_and_coverage_states():
	...
	decision = build_decision_ref("d-1", "student_nba", subject, "recommend", "nba-r1", evidence_refs=["score:score-1:7"], finding_refs=[finding["finding_id"]], expires_at="2026-12-01T00:00:00Z")
