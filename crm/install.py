...
def add_default_fields_layout(force=False):
	quick_entry_layouts = {
		"CRM Student-Quick Entry": {
			"doctype": "CRM Student",
			"layout": '[{"name":"details_section","columns":[{"name":"col_name","fields":["full_name","phone","email"]},{"name":"col_status","fields":["student_stage","assigned_to","admission_year"]}]},{"name":"section_parents","columns":[{"name":"col_parent1","fields":["parent_name"]},{"name":"col_parent2","fields":["parent_phone"]}]},{"name":"admission_section","columns":[{"name":"col_academic","fields":["province","high_school"]},{"name":"col_major","fields":["major","aspiration"]}]},{"name":"section_enrollment","columns":[{"name":"col_enroll1","fields":["source"]},{"name":"col_enroll2","fields":["branch"]}]}]',
		},
		"CRM Lead-Quick Entry": {
			"doctype": "CRM Lead",
			"layout": '[{"name":"details_section","columns":[{"name":"col_name","fields":["student_name","phone","email"]},{"name":"col_status","fields":["processing_status","resolution","source","branch"]}]},{"name":"academic_section","columns":[{"name":"col_location","fields":["province","high_school","major"]},{"name":"col_admission","fields":["ward","admission_year","aspiration"]}]}]',
		},
		"Contact-Quick Entry": {
			"doctype": "Contact",
	...
	data_fields_layouts = {
		"CRM Student-Data Fields": {
			"doctype": "CRM Student",
			"layout": '[{"name":"first_tab","sections":[{"label":"Details","name":"details_section","opened":true,"columns":[{"name":"col_main","fields":["full_name","phone","email"]},{"name":"col_status","fields":["student_stage","assigned_to","admission_year"]}]},{"label":"Parent Information","name":"section_parents","opened":true,"columns":[{"name":"col_parent1","fields":["parent_name"]},{"name":"col_parent2","fields":["parent_phone"]}]},{"label":"Student Profile","name":"section_academic","opened":true,"columns":[{"name":"col_school","fields":["province","high_school"]},{"name":"col_major","fields":["major","aspiration"]}]},{"label":"Enrollment Information","name":"section_enrollment","opened":true,"columns":[{"name":"col_enroll1","fields":["source"]},{"name":"col_enroll2","fields":["branch"]}]},{"label":"Academic & Scores","name":"section_academic_history","opened":false,"columns":[{"name":"col_scores1","fields":["cohort_start_year","education_program","graduation_score","transcript_score"]},{"name":"col_scores2","fields":["cohort_end_year","admission_method","english_converted_score","total_score"]}]},{"label":"Results","name":"section_academic_tables","opened":false,"columns":[{"name":"col_tables","fields":["academic_results","language_certificates"]}]},{"label":"Notes","name":"notes_section","opened":true,"columns":[{"name":"col_notes","fields":["notes"]}]}]}]',
		},
		"CRM Lead-Data Fields": {
			"doctype": "CRM Lead",
			"layout": '[{"name":"first_tab","sections":[{"label":"Details","name":"details_section","opened":true,"columns":[{"name":"col_main","fields":["student_name","phone","email"]},{"name":"col_status","fields":["processing_status","resolution","branch"]}]},{"label":"Admission","name":"admission_section","opened":true,"columns":[{"name":"col_location","fields":["source","province","high_school","major"]},{"name":"col_academic","fields":["ward","admission_year","aspiration"]}]},{"label":"Academic & Scores","name":"section_academic_history","opened":true,"columns":[{"name":"col_scores1","fields":["cohort_start_year","education_program","graduation_score","transcript_score"]},{"name":"col_scores2","fields":["cohort_end_year","admission_method","english_converted_score","total_score"]}]},{"label":"Results","name":"section_academic_tables","opened":true,"columns":[{"name":"col_tables","fields":["academic_results","language_certificates"]}]},{"label":"Notes","name":"notes_section","opened":true,"columns":[{"name":"col_notes","fields":["notes"]}]}]}]',
		},
...
def add_default_quick_filters():
	quick_filters = {
		"CRM Lead": ["student_name", "phone", "email", "processing_status", "resolution", "assigned_to", "source"],
		"CRM Student": ["full_name", "phone", "email", "student_stage", "assigned_to", "source"],
