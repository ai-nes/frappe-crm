...
def set_crm_session_language():
	...
	target_lang = user_lang or system_lang or "vi"
...
def get_context():
	...
	if not check_app_permission():
		frappe.throw(_("You do not have permission to access FPTU CRM"), frappe.PermissionError)

	set_crm_session_language()
	frappe.db.commit()
...
def get_boot():
	target_lang = set_crm_session_language()
	return frappe._dict(
		{
