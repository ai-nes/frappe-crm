...
permission_query_conditions = {
	...
	"CRM AI Student Insight": "crm.fcrm.permissions.get_student_projection_permission_query_conditions",
...
has_permission = {
	...
	"CRM AI Student Insight": "crm.fcrm.permissions.has_student_projection_permission",
