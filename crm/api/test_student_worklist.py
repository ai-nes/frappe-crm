...
class TestStudentWorklist(FrappeTestCase):
	def test_sort_key_is_priority_then_timing_creation_and_id(self):
		...
		medium = frappe._dict(
			priority="medium", recommended_timing="2025-01-01", creation="2026-01-01", name="REC-1"
		)
		earlier = frappe._dict(
			priority="high", recommended_timing="2026-01-01", creation="2026-01-03", name="REC-3"
		)
