...
_MENU_ROUTES = {
	...
	"lead_sales": "lead_team_dashboard:team-dashboard:overview lead_team_sla:team-sla:running lead_sla_running:team-sla:running lead_sla_near_breach:team-sla:near-breach lead_sla_breached:team-sla:breached lead_sla_violations:team-sla:history lead_team_records:team-records:stage lead_records_by_stage:team-records:stage lead_records_by_agent:team-records:owner lead_records_unassigned:team-records:unowned lead_records_cold:team-records:cold-abandoned lead_assignment:team-assignment:queue lead_member_performance:team-performance:members lead_team_tasks:team-tasks:open lead_duplicates:team-duplicates:review lead_team_reports:team-reports:overview lead_lookups:admissions-reference:home lead_lookup_majors:admissions-reference:programs lead_lookup_tuition:admissions-reference:tuition-aid lead_lookup_quota:admissions-reference:quota lead_lookup_high_schools:admissions-reference:schools lead_sla_policy_readonly:sla-policy:read".split(),
...
def badge_workspaces(profile: str) -> tuple[str, ...]:
	return {
		...
		"lead_sales": ("lead_team_sla", "lead_assignment", "lead_duplicates"),
		"marketing": ("mkt_costs",),
