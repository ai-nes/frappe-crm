		...
		self.assertEqual(
			student_lifecycle.get_lifecycle_stages(),
			{
				"stages": [
					...
					{"stage": "Registration", "label": "Registration", "order": 4, "is_terminal": False},
					{"stage": "New Enter", "label": "Nhập học", "order": 5, "is_terminal": True},
					{"stage": "Disqualified", "label": "Disqualified", "order": 6, "is_terminal": True},
				],
				"policy_version": "phase5-lifecycle-v1",
			},
		)
