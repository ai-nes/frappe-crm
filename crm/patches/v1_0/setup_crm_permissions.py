...
DOCTYPE_PERMS = {
	...
	"CRM Task":     OPS_PERMS,
	"CRM Call Log": OPS_PERMS,
	"FCRM Note":    OPS_PERMS,
	# System / config
	"CRM Fields Layout":           SYS_PERMS,
	"CRM Form Script":             SYS_PERMS,
	"CRM View Settings":           SYS_PERMS,
	"CRM Global Settings":         SYS_PERMS,
	"FCRM Settings":               SYS_PERMS,
	"CRM Notification":            SYS_PERMS,
	"CRM Dashboard":               SYS_PERMS,
	"CRM Invitation":              SYS_PERMS,
	"CRM Telephony Agent":         SYS_PERMS,
	"CRM Service Level Agreement": SYS_PERMS,
