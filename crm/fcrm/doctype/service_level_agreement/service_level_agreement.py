...
from crm.fcrm.doctype.service_level_agreement.utils import get_context
...
class ServiceLevelAgreement(Document):
	...
	if TYPE_CHECKING:
		...
		from crm.fcrm.doctype.service_day.service_day import ServiceDay
		from crm.fcrm.doctype.service_level_priority.service_level_priority import (
		...
		working_hours: DF.Table[ServiceDay]
