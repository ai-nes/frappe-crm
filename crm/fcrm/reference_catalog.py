...
REFERENCE_CATALOG: Final[dict[str, tuple[dict, ...]]] = {
	...
	"CRM Campaign Type": (),
	"CRM Intent Type": (
		{"code": "PROGRAM_INTEREST", "display_name": "Quan tâm ngành học", "sort_order": 10, "importance": "Medium"},
		{"code": "ADMISSION_REQUIREMENT", "display_name": "Điều kiện tuyển sinh", "sort_order": 20, "importance": "High"},
		...
		{"code": "APPLICATION_GUIDANCE", "display_name": "Hướng dẫn đăng ký", "sort_order": 50, "importance": "High"},
		{"code": "APPLICATION_STATUS", "display_name": "Tình trạng hồ sơ", "sort_order": 60, "importance": "Medium"},
		{"code": "DOCUMENT_REQUIREMENT", "display_name": "Yêu cầu hồ sơ", "sort_order": 70, "importance": "Medium"},
		{"code": "DEADLINE", "display_name": "Thời hạn tuyển sinh", "sort_order": 80, "importance": "High"},
		{"code": "CAREER_COUNSELING", "display_name": "Tư vấn định hướng", "sort_order": 90, "importance": "High"},
		{"code": "CAMPUS_INFORMATION", "display_name": "Thông tin trường", "sort_order": 100, "importance": "Medium"},
		{"code": "STUDENT_LIFE", "display_name": "Đời sống sinh viên", "sort_order": 110, "importance": "Medium"},
		{"code": "ENROLLMENT_CONFIRMATION", "display_name": "Xác nhận nhập học", "sort_order": 120, "importance": "Very High"},
		{"code": "WITHDRAWAL_OR_HESITATION", "display_name": "Do dự hoặc từ chối", "sort_order": 130, "importance": "Medium"},
		{"code": "REQUEST_CONTACT", "display_name": "Yêu cầu liên hệ", "sort_order": 140, "importance": "High"},
